...
\SynapticSubject{User manual for synaptic version 2.3.0}
...
Journal titles are underlined by an editorial double rule; book titles rest
on a short primary bar; lecture and notes mastheads use a single rule whose
...
Page numbers sit centred in the footer; book mode additionally respects outer
running heads and duplex blank pages.
...
Teaching and notes cards share one visual language: square corners, a west
accent bar tinted with the semantic colour of the card (primary, secondary,
warning, or success), and a light surface with a readable title colouring.
...
are presented as refined cards: a subtle theme-tinted background, a west accent
bar, and square corners matching the teaching and notes card language.
...
\texttt{remark}; a custom theorem is boxed automatically.
...
The v2.3 API is unchanged from v2.2. Lower-case book matter helpers and generic

...
\SynapticSubject{synaptic 4.0.0 用户手册}
...
书籍中可使用 \DocCmd{SynapticFrontMatter}、\DocCmd{SynapticMainMatter} 和
\DocCmd{SynapticBackMatter}，以及目录、图表目录、附录、章副标题与题词辅助命令。
notes 模式提供 \texttt{synkeyidea}、\texttt{synquestion}、\texttt{syntodo} 和
\texttt{synsummary}，并兼容文档类的双栏布局。\DocCmd{SynapticAcknowledgments} 在书籍模式中生成章，
